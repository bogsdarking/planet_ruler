...
class TestTkMaskSelectorInitialization:
    """Test TkMaskSelector initialization and setup"""
...
class TestMaskNormalization:
    """Test mask format normalization"""
    ...
    def test_mask_sorting_by_area(self):
        ...
        medium_mask = np.ones((100, 100), dtype=bool)
...
class TestGUIComponents:
    """Test GUI component creation and interaction"""
    ...
    def test_update_mask_list(self):
        ...
        with patch('tkinter.Tk'), patch.object(TkMaskSelector, '_build_gui'), \
            ...
            assert selector.mask_listbox.itemconfig.call_count == 2
...
class TestCanvasInteraction:
    """Test canvas click and interaction handling"""
...
class TestPanningAndZooming:
    ...
    def test_start_pan(self):
        ...
        with patch('tkinter.Tk'), patch.object(TkMaskSelector, '_build_gui'), \
            ...
            selector.canvas.config.assert_called_with(cursor="fleur")
    ...
    def test_do_pan(self):
        ...
        with patch('tkinter.Tk'), patch.object(TkMaskSelector, '_build_gui'), \
            ...
            assert selector.last_mouse_x == 120
            assert selector.last_mouse_y == 180
    ...
    def test_zoom_clamping(self):
        ...
        with patch('tkinter.Tk'), patch.object(TkMaskSelector, '_build_gui'), \
            ...
            with patch.object(selector, '_create_overlay_image'), \
                ...
                event.delta = -120
                selector.on_mousewheel(event)
                assert selector.zoom_level >= 0.1  # Should be clamped
...
class TestFinishAndCleanup:
    """Test finish method and cleanup"""
