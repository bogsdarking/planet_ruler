...
class TestLimbDetectionBenchmarks:
    ...
    def test_observation_for_detection(self):
        ...
        image_path = "demo/images/PIA19948.jpg"
    ...
    def test_manual_limb_detection_benchmark(
        ...
        # These are 19 points tracing Pluto's limb in the PIA19948.jpg image (scaled to 50% resolution)
        pluto_limb_points = [
            [16.669374492282695, 547.3111291632819],
            [75.01218521527212, 498.69212022745736],
            [151.4134849715678, 440.3493095044679],
            [225.0365556458164, 397.2867587327376],
            [338.9439480097481, 337.5548334687246],
            [429.2363931762794, 295.88139723801786],
            [550.089358245329, 256.9861900893582],
            [663.9967506092607, 226.42567018418995],
            [736.2307067424857, 211.1454102355808],
            [833.4687246141368, 198.64337936368804],
            [940.4305442729488, 190.30869211755486],
            [1019.610073111292, 188.9195775792039],
            [1108.5134037367993, 193.08692120227457],
            [1182.1364744061048, 201.4216084484159],
            [1289.0982940648819, 213.9236393202927],
            [1400.2274573517464, 236.14944805194805],
            [1491.9090170593013, 262.54264825345245],
            [1590.5361494719739, 294.49228269699426],
            [1678.0503655564579, 333.387449848954],
        ]
        image_width = 1710  # PIA19948.jpg width (half of original 3420 due to resize)
