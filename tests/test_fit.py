...
class TestGradientFieldCostFunction:
    ...
    def test_gradient_field_simple_initialization(self, test_image, simple_horizon_function):
    ...
    def test_gradient_field_cost_valid_params(self, test_image, simple_horizon_function):
    ...
    def test_gradient_field_cost_simple_valid_params(self, test_image, simple_horizon_function):
    ...
    def test_gradient_field_cost_invalid_coords(self, test_image, simple_horizon_function):
    ...
    def test_gradient_field_cost_simple_invalid_coords(self, test_image, simple_horizon_function):
    ...
    def test_gradient_field_cost_out_of_bounds(self, test_image, simple_horizon_function):
...
class TestUnpackDiffEvolPosteriors:
    ...
    def test_unpack_diff_evol_posteriors_empty_population(self):
        ...
        assert "r" in result.columns or len(result.columns) == 0  # Depending on pandas behavior
