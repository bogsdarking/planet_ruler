...
> From the stated mission parameters, the [WAC](https://ciclops.org/iss/iss.php.html) has a 2.0077 m focal length. Since we're pretty sure about this one, let's give it a very small (1 mm) tolerance.

- **[fov]** The angle observed by the camera (degrees).

> Again we can pull this from the mission parameters -- 3.5 degrees. The solver will automatically give this a 1% tolerance.
