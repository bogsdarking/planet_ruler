...
import numpy as np
import math
from planet_ruler.image import bidirectional_gradient_blur, bilinear_interpolate, gradient_field
...
class CostFunction:
    ...
    def __init__(
        ...
        elif loss_function == 'gradient_field' or loss_function == 'gradient_field_simple':
            self.target = None
